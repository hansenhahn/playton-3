# Secundários — London Presente & Outros

> **Fonte:** `Spec/Capitulo_00_Prologo.md:57`–`Spec/Capitulo_06.md:58`
> **Cobre:** Prólogo banquete + Gressenheller + Scotland Yard + Midland Road presente.

## Caroline & Bill Hawks (カレリナ首相夫人 / ビル・ホーク)
- **Caroline:** esposa do PM, esnobe `Oh, this food is simply dreadful, Bill. Do get this over with quickly` (`Spec/Capitulo_00_Prologo.md:161`), `This event is a complete charade!` Controladora.
- **Bill Hawks:** PM distraído `Yes, dear...`, `Is this thing real?` (`Spec/Capitulo_00_Prologo.md:198`), speech `Today is a monumental day not only for our great nation... We have conquered the skies and the seas... until now.` (`Spec/Capitulo_00_Prologo.md:203`), provocado aceita entrar na máquina, depois desaparecido 10 anos. Em `Spec/Capitulo_14.md:109` cético `We're making our escape by car?! Is this some kind of joke?` e autoritário `Somebody apprehend that man at once!`
- **Registro:** político grandiloquente vs esposa seca. PT-BR: manter `Primeiro-ministro Bill Hawks`, esposa `Caroline`.
- **Tradução:** speech do PM é registro político pomposo, não coloquial.

## MC / Mestre de Cerimônias (披露会場司会者)
- **Papel:** `Ladies and gentlemen! Thank you for taking part in an event that will undoubtedly go down in scientific history.` (`Spec/Capitulo_00_Prologo.md:193`). Formal cerimonial.
- **PT-BR:** `Mestre de cerimônias`, voz de locutor.

## Smith (スミス) — Security Guard
- **Papel:** tutorial intruso `Oh crumbs, I've really blown it...` (`Spec/Capitulo_00_Prologo.md:184`), pede `Splendid work, my boy!` pós-puzzle.
- **Personalidade:** nervoso `Oh crumbs`, `I'm done for!`
- **PT-BR:** guarda atrapalhado.
...
- **Personalidade:** provocadora, `Heh heh!`, `Professor L` (marca).
- **Registro:** jovem universitária sedutora, informal `Heya, Professor L`.
- **PT-BR:** manter `Professor L` (não `Prof. L`), traduzir `pipsqueak` → `nanico` / `baixinho`.

## Dean Delmona (デルモナ学長) / Future Delmona (未来デルモナ)
- **Papel:** Presente: `Hershel, my boy! I've been looking for you! ... My darling granddaughter brought it to me, but I can't solve... Let's keep... between you, me and the wall` (`Spec/Capitulo_05.md:165`). Futuro: `Oho! Fancy seeing you here, Hershel! My hair's gone completely white... London's full of people quick to sully your name.` (`Spec/Capitulo_06.md:679`), depois desmascarado como Don Paolo disfarçado (peruca).
- **Registro:** idoso caloroso `Hershel, my boy!`, `Hoo hoo!`.
- **PT-BR:** `Reitor Delmona`.

## Corgi (コーギー) — Scotland Yard Reception
- **Papel:** `Welcome to Scotland Yard... I'm under strict orders to issue this puzzle to all visitors.` (`Spec/Capitulo_05.md:424`), fã `How could any self-respecting puzzler NOT know the name Layton?` (`Spec/Capitulo_05.md:437`).
- **Registro:** policial formal entusiasmado.
...
- **Pistas visuais → texto:** `wet footprints` e `building sites` são foreshadow — tradução literal consistente ajuda jogador conectar.
- **Flora delay:** Rosetta vs Flora — Rosetta é agressiva jovem, Flora é ressentida doce; não uniformizar.
